...
using namespace std; // VQE section, Qiskit circuit code
...
// VQE section
template <typename T>
T Wavefunction_calculations<T>::Set_circuit()
    {
    unsigned int i, j;
    unsigned int k, l;
    unsigned int sum_electrons;
...
template <typename T>
T Wavefunction_calculations<T>::Run_circuit(vector<double>& ansatz)
    {
    unsigned int i, j, k;
    unsigned int sum_electrons;
    unsigned int pow;
...
// VQE section
template <typename T>
T Wavefunction_calculations<T>::Execute_PBE_VQE(unsigned int max_iterations, T minimal_fidelity, unsigned int size_order, bool dealocate,
vector<T>* values, vector<T>* spin_density_vector, vector<T>* spin_values)
    {
    unsigned int i, j;
    unsigned int matrix_order;
